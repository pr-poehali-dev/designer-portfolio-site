...
const portfolioItems: PortfolioItem[] = [
  {
    ...
    year: "2023",
    description: "Разработка новой визуальной идентичности для современного культурного центра. Проект включал создание логотипа, фирменного стиля и системы навигации.",
    category: "Брендинг",
  ...
  },
  {
    ...
    year: "2022",
    description: "Разработка концепции и дизайна ежеквартального журнала об архитектуре и городском пространстве. Фокус на типографике и минималистичной сетке.",
    category: "Печатный дизайн",
    thumbnail: "https://images.unsplash.com/photo-1584448097764-374f81551427?q=80&w=800&auto=format&fit=crop",
    images: [
  ...
  },
  {
    ...
    year: "2023",
    description: "Дизайн минималистичного интерфейса для производителя современной мебели. Акцент на удобстве использования и качественной презентации продукции.",
    category: "Веб-дизайн",
    thumbnail: "https://images.unsplash.com/photo-1552679549-21d1e7d4b69e?q=80&w=800&auto=format&fit=crop",
    images: [
  ...
  },
  {
    ...
    year: "2022",
    description: "Разработка визуальной концепции и айдентики для ежегодного фестиваля дизайна. Включая логотип, постеры, веб-сайт и маркетинговые материалы.",
    category: "Айдентика",
  ...
  return (
    <section id="portfolio" className="py-20">
      <div className="container mx-auto px-4">
        <h2 className="text-3xl md:text-4xl font-bold mb-4 uppercase tracking-wider">Портфолио</h2>
        <p className="mb-12 max-w-2xl">Избранные проекты из различных областей графического дизайна.</p>
